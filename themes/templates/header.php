...
echo "<script type='text/javascript' src='https://code.jquery.com/jquery-1.7.2.min.js'></script>\n";
echo "<script type='text/javascript' src='".INCLUDES."jscript.js'></script>\n";
echo "<meta property='og:image' content='http://progvill.hu/images/photoalbum/album_2/features_thunderbolt_icon20110224_t1.jpg' />\n";
echo "</head>\n<body>\n";
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/hu_HU/sdk.js#xfbml=1&version=v2.10&appId=145689496036132";
